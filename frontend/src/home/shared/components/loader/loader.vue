    ...
    <div class="loader-wrapper">
        <svg width="80px" height="80px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"
            ...
            <g class="st2" transform="rotate(79.242 53.064 52)">
                ...
                <animateTransform attributeName="transform" type="rotate" calcMode="linear"
                                  values="0 53.064 52;360 53.064 52"
                                  keyTimes="0;1" dur="0.9657s" begin="0s" repeatCount="indefinite"></animateTransform>
            </g>
            ...
            <polygon
                    ...
                    fill="#aaa">
                <animate attributeName="opacity" calcMode="linear" values="0;0;1;1;0" keyTimes="0;0.4;0.5;0.9;1"
                         dur="0.9657"
            ...
            <g>
                <polyline points="35.5,77.5 27.5,89.5 24,89.5   " class="st3"
                          stroke="#aaa"></polyline>
                <rect x="7" y="86" width="17" height="7" class="st4"
                      stroke="#aaa"></rect>
            </g>
            <g>
                <polyline points="59,22 69,12 82,12   " class="st4"
                          stroke="#aaa"></polyline>
                <circle cx="87" cy="12" r="5" class="st4" stroke="#aaa"></circle>
            </g>
        </svg>
    </div>
</template>

<style scoped src="./loader.scss" lang="scss"></style>
